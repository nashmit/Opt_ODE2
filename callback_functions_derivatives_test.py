...
# https://groups.google.com/g/casadi-users/c/CRsBsbpZruo/m/SNYKdnD8BQAJ
        ...
        class JacFun(Callback):
            ...
            def get_sparsity_in(self,i):
                if i==0: # nominal input
                    ...
                    return  Sparsity(3,1) # because it doesn't need to evaluate the expression  #Sparsity.dense(3,1)
            ...
            # Evaluate numerically
            def eval(self, arg):
                print("Jacobian ( direct computation ):")
                a,b,c,d = vertsplit(arg[0])
                ret = DM(3,4)
                ret[0,2] = d*cos(c)
                ret[0,3] = sin(c)+2*d
